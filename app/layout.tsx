...
export const metadata: Metadata = {
  title: "ScriptedStuff",
  description: "A blog about scripting, automation, and tech wizardry",
};
        ...
        <footer className="border-t border-gray-700 mt-12">
          <div className="container mx-auto px-4 py-8">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-gray-400 text-sm">© {new Date().getFullYear()} ScriptedStuff. Built with Next.js.</p>
            </div>
          </div>
        </footer>
      </body>
